...
public class TelaListagemAlunos extends javax.swing.JFrame {
    ...
    //Construtor:
    public TelaListagemAlunos(ControladorComponenteListagem controlador) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Object elementoAluno = this.jList1.getModel().getElementAt(this.jList1.getSelectedIndex());
        Aluno aluno = (Aluno) elementoAluno;
        String mensagem;
        mensagem = String.valueOf("CPF: " + aluno.getCpf() + "\n" + "RG: " + aluno.getRg() + "\n" + 
                "Nascimento: " + aluno.getDataNascimento().get(Calendar.DATE) + "/" + aluno.getDataNascimento().get(Calendar.MONTH)+ "/"+ aluno.getDataNascimento().get(Calendar.YEAR) +
                "\n" + "Telefone: " + aluno.getTelefone() + "\n" + "Endereço: " + aluno.getEndereco());
        JOptionPane.showMessageDialog(this, mensagem);
    }//GEN-LAST:event_jButton2ActionPerformed

    private DefaultListModel definirModelo(Object[] arrayAlunos) {
        DefaultListModel modelo = new DefaultListModel();
        int index = 0;
        for (Object aluno : arrayAlunos) {
            Aluno alun = (Aluno) aluno;
            modelo.add(index, alun);
            index++;
        }
     ...
     */
    public void iniciar(Object[] arrayAlunos) {
        DefaultListModel alunos = this.definirModelo(arrayAlunos);
        this.setModeloJList(alunos);
